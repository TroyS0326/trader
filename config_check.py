...
def validate_required_production_config(strict: bool = False) -> list[str]:
    ...
    required = [
        ...
        'BREVO_API_KEY','BREVO_SENDER_EMAIL','ALPACA_CLIENT_ID','ALPACA_CLIENT_SECRET','ALPACA_REDIRECT_URI','FINNHUB_API_KEY','GEMINI_API_KEY'
    ]
    for key in required:
    ...
    database_url = normalize_database_url(_value('DATABASE_URL'))
