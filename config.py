...
UNPROTECTED_POSITION_REPAIR_ENABLED = os.getenv("UNPROTECTED_POSITION_REPAIR_ENABLED", "1") == "1"
UNPROTECTED_POSITION_REPAIR_LIVE_ENABLED = os.getenv("UNPROTECTED_POSITION_REPAIR_LIVE_ENABLED", "0") == "1"
EMERGENCY_EXIT_SLIPPAGE_PCT = float(os.getenv("EMERGENCY_EXIT_SLIPPAGE_PCT", "0.02"))
EMERGENCY_EXIT_RETRY_FAILED_ENABLED = os.getenv("EMERGENCY_EXIT_RETRY_FAILED_ENABLED", "0") == "1"
...
DAILY_DRAWDOWN_LIMIT_PCT = float(os.getenv('DAILY_DRAWDOWN_LIMIT_PCT', '0.05'))   # 5% daily loss ceiling
DAILY_DRAWDOWN_HARD_FLOOR = float(os.getenv('DAILY_DRAWDOWN_HARD_FLOOR', '25.0')) # never block below $25 loss
PER_TRADE_LOSS_CAP_PCT = float(os.getenv('PER_TRADE_LOSS_CAP_PCT', '0.07'))       # 7% per-trade hard cap
UNPROTECTED_POSITION_REPAIR_LIVE_ENABLED = os.getenv("UNPROTECTED_POSITION_REPAIR_LIVE_ENABLED", "1") == "1"
...
AGGRESSIVE_INTRADAY_ENABLED = os.getenv("AGGRESSIVE_INTRADAY_ENABLED", "0") == "1"
AGGRESSIVE_ALLOW_LUNCH_TRADING = os.getenv("AGGRESSIVE_ALLOW_LUNCH_TRADING", "0") == "1"
AGGRESSIVE_PROMOTE_SCAN_DECISIONS_ENABLED = os.getenv("AGGRESSIVE_PROMOTE_SCAN_DECISIONS_ENABLED", "0") == "1"
AGGRESSIVE_PROMOTION_LIVE_ENABLED = os.getenv("AGGRESSIVE_PROMOTION_LIVE_ENABLED", "0") == "1"
AGGRESSIVE_PROMOTE_SCAN_DECISIONS = os.getenv("AGGRESSIVE_PROMOTE_SCAN_DECISIONS", "SKIP,WATCH,WATCH FOR BREAKOUT").strip()
AGGRESSIVE_PROMOTION_MAX_RISK_PER_SHARE_PCT = float(os.getenv("AGGRESSIVE_PROMOTION_MAX_RISK_PER_SHARE_PCT", "0.08"))
AGGRESSIVE_TIGHTEN_PROMOTION_PLAN_ENABLED = os.getenv("AGGRESSIVE_TIGHTEN_PROMOTION_PLAN_ENABLED", "0") == "1"
AGGRESSIVE_TIGHTEN_PROMOTION_LIVE_ENABLED = os.getenv("AGGRESSIVE_TIGHTEN_PROMOTION_LIVE_ENABLED", "0") == "1"
AGGRESSIVE_TIGHTEN_PROMOTION_MIN_RR_TARGET_1 = float(os.getenv("AGGRESSIVE_TIGHTEN_PROMOTION_MIN_RR_TARGET_1", "1.20"))
ACTIVE_SYMBOL_ROTATION_ENABLED = os.getenv("ACTIVE_SYMBOL_ROTATION_ENABLED", "1") == "1"
EXECUTION_SYMBOL_COOLDOWN_MINUTES = int(os.getenv("EXECUTION_SYMBOL_COOLDOWN_MINUTES", "20"))
EXECUTION_MAX_SAME_SYMBOL_TRADES_PER_DAY = int(os.getenv("EXECUTION_MAX_SAME_SYMBOL_TRADES_PER_DAY", "3"))
EXECUTION_MAX_ENTRY_QUOTE_DRIFT_PCT = float(os.getenv("EXECUTION_MAX_ENTRY_QUOTE_DRIFT_PCT", "0.06"))
EXECUTION_QUOTE_DRIFT_GUARD_ENABLED = os.getenv("EXECUTION_QUOTE_DRIFT_GUARD_ENABLED", "1") == "1"

AGGRESSIVE_MORNING_MIN_OPPORTUNITY = int(os.getenv("AGGRESSIVE_MORNING_MIN_OPPORTUNITY", "65"))
AGGRESSIVE_MORNING_MIN_TRADABILITY = int(os.getenv("AGGRESSIVE_MORNING_MIN_TRADABILITY", "45"))
AGGRESSIVE_MORNING_MIN_ENTRY_QUALITY = int(os.getenv("AGGRESSIVE_MORNING_MIN_ENTRY_QUALITY", "40"))

AGGRESSIVE_MIDDAY_MIN_OPPORTUNITY = int(os.getenv("AGGRESSIVE_MIDDAY_MIN_OPPORTUNITY", "75"))
AGGRESSIVE_MIDDAY_MIN_TRADABILITY = int(os.getenv("AGGRESSIVE_MIDDAY_MIN_TRADABILITY", "45"))
AGGRESSIVE_MIDDAY_MIN_ENTRY_QUALITY = int(os.getenv("AGGRESSIVE_MIDDAY_MIN_ENTRY_QUALITY", "55"))

AGGRESSIVE_POWER_HOUR_MIN_RS = float(os.getenv("AGGRESSIVE_POWER_HOUR_MIN_RS", "1.0"))
AGGRESSIVE_POWER_HOUR_MIN_TRADABILITY = int(os.getenv("AGGRESSIVE_POWER_HOUR_MIN_TRADABILITY", "45"))

AGGRESSIVE_MOMENTUM_MIN_DAY_CHANGE_PCT = float(os.getenv("AGGRESSIVE_MOMENTUM_MIN_DAY_CHANGE_PCT", "15.0"))
AGGRESSIVE_MOMENTUM_MIN_RVOL = float(os.getenv("AGGRESSIVE_MOMENTUM_MIN_RVOL", "1.5"))
AGGRESSIVE_MOMENTUM_PULLBACK_MIN_RVOL = float(os.getenv("AGGRESSIVE_MOMENTUM_PULLBACK_MIN_RVOL", "1.2"))
