...
MIN_BROAD_PRICE = float(os.getenv("MIN_BROAD_PRICE", os.getenv("SCAN_MIN_PRICE", "1.0")))
MAX_BROAD_PRICE = float(os.getenv("MAX_BROAD_PRICE", os.getenv("SCAN_MAX_PRICE", "500.0")))
