...
DAILY_DRAWDOWN_LIMIT_PCT   = float(os.getenv('DAILY_DRAWDOWN_LIMIT_PCT',   '0.05'))  # 5% daily account loss ceiling
DAILY_DRAWDOWN_HARD_FLOOR  = float(os.getenv('DAILY_DRAWDOWN_HARD_FLOOR',  '25.0'))  # never trigger below $25 loss
PER_TRADE_LOSS_CAP_PCT     = float(os.getenv('PER_TRADE_LOSS_CAP_PCT',     '0.07'))  # 7% of bankroll per-trade hard cap
